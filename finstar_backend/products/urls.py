...
urlpatterns = [
    ...
    path("admin/seo/products/<int:product_id>/generate-and-publish", SEOGenerateAndPublishView.as_view(), name="admin-seo-generate-and-publish"),
    path("admin/seo/products/<int:product_id>/generate-and-publish/", SEOGenerateAndPublishView.as_view()),
